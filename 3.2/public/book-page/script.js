  ...
  fetch(BASE_URL + "/books/order/", {
    ...
    .then((response) => {
      if (response.status === "ok") {
        ...
        $('#modalMessageBody')
        .text(`Книгу "${bookTitle}" вільна і ти можеш прийти за нею. Наша адреса м.Кропивницький, пров.Василівський 10, 5 поверх. Краще попередньо зателефонувати і попередить нам, щоб не втрапити в незручну ситуацію. 
Тел. 097 123 45 67`);
